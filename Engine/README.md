...
This project contains reusable, game-agnostic C++ engine modules. The current foundation implements `GameEX::Startup`, `GameEX::Core`, and `GameEX::PlatformSDL`: a validated serial subsystem lifecycle, a minimal application lifetime, a platform capability boundary, and an SDL3 desktop-window backend.
