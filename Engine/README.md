...
The engine must not contain transport simulation, Czech Republic source-data interpretation, editor workflows, or runtime knowledge of the world compiler. Vulkan will be isolated behind a future RHI target; SDL3 is not being used as a rendering abstraction.
